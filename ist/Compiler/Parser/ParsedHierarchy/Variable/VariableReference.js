            ...
            if (targetForCount) {
                ...
                if (targetFlow && targetFlow.isFunction) {
                    ...
                    if (parent instanceof Weave ||
                        ...
                        this.Warning(`'${targetFlow.name}' being used as read count rather than being called as function. Perhaps you intended to write ${targetFlow.name}()`);
                    }
                }
                return;
            }
